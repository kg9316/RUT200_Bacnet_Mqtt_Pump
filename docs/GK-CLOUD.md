...
The temporary router snapshot uses the same compact point fields and omits live values
and duplicate device names. The persistent GUID registry is unchanged.
